...
var OpenPlace = React.createClass({
  ...
  render: function() {
      ...
      return(
        <ParallaxView
                ...
                backgroundSource={{ uri: "http://mpba.sk/sites/default/files/imagecache/colorbox_view/lokality/648_sandberg2.jpg" }}
                windowHeight={200}
                header={HEADER}>
